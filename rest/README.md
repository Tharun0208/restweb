...
<head>
    ...
    <title>Welcome to VJN's Kitchen</title>
    <style>
        body {
...
<body>
    <!-- Header Section -->
    <div class="banner">
        <h1>Welcome to VJN's Kitchen</h1>
    ...
    <div class="welcome-section">
        <h2>About Us</h2>
        <p>At VJN's Kitchen, A pleasant ambiance, whether it's cozy, lively, or elegant, contributes to a positive dining experience.</p>
    </div>
...
## OUTPUT:
![alt text](<Screenshot 2024-12-26 131744.png>)
![alt text](<Screenshot 2024-12-26 133339.png>)
![alt text](<Screenshot 2024-12-26 133352.png>)
![alt text](<Screenshot 2024-12-26 133506.png>)
## RESULT:
